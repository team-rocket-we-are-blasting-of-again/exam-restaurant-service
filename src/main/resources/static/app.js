function activate() {
  ...
  $.ajax({
    type: "POST",
    url: "http://localhost:9080/api/auth/getcode",
    data: mobileFormData,
...
function loadContacts() {
  ...
  $.ajax({
    type: "POST",
    url: "http://localhost:9080/api/auth/getcontacts",
...
function connect() {
	ws = new WebSocket('ws://localhost:9080/messaging?accessToken=' + $("#accessToken").val());
